...
def main(args):
    ...
    concatenate_txt(args, file_path, txt_list=["/vol/bitbucket/fl4718/monodepth2/splits/clouds/more_val.txt",
                                               "/vol/bitbucket/fl4718/monodepth2/splits/clouds/val_files.txt"])
